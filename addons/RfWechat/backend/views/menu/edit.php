...
use addons\RfWechat\common\enums\MenuLanguageEnum;
use addons\RfWechat\common\enums\MenuClientPlatformTypeEnum;
use addons\RfWechat\common\enums\MenuSex;
...
<?= AddonHelper::jsFile('js/sortable.min.js')?>
            ...
            <div class="col-sm-6">
                <div class="box">
                    ...
                    <div class="box-content clearfix normalPaddingJustV">
                        <div class="col-sm-12">
                            <div class="col-sm-3">
                                <?= $form->field($model, 'sex')->dropDownList(MenuSex::getMap(),[
                                    'disabled' => $model->isNewRecord ? false : true
                                ])->label('性别') ?>
                            </div>
                            <div class="col-sm-3">
                                <?= $form->field($model, 'client_platform_type')->dropDownList(MenuClientPlatformTypeEnum::getMap(),[
                                    'disabled' => $model->isNewRecord ? false : true
                                ])->label('系统') ?>
                            </div>
                            <div class="col-sm-3">
                                <?= $form->field($model, 'language')->dropDownList(MenuLanguageEnum::getMap(), [
                                    'disabled' => $model->isNewRecord ? false : true
                                ])->label('语言') ?>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-6">
                                <?= $form->field($model, 'province')->dropDownList(Yii::$app->wechatServices->menuProvinces->getMapList(1),[
                                    'prompt' => '不限',
                                    "@change" => "province",
                                    'disabled' => $model->isNewRecord ? false : true
                                ])->label('省/直辖市') ?>
