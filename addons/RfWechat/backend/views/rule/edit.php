...
use addons\RfWechat\backend\widgets\selector\Select;
    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            ...
            <div id="tab-6" class="tab-pane">
                <div class="panel-body">
                    <?= $form->field($model, 'api_url')->dropDownList($apiList)->hint('1、添加此模块的规则后，只针对于单个规则定义有效，如果需要全部路由给接口处理，则修改该模块的优先级顺序<br>2、本地文件存放在公共文件夹内(/backend/modulesuserapis)下<br>3、文件名格式为*Api.php，例如：TestApi.php') ?>
