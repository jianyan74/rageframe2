                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?= $form->field($model, 'wechat_message')->checkboxList(WechatEnum::$typeExplanation)->hint('当前模块能够直接处理的消息类型(没有上下文的对话语境, 能直接处理消息并返回数据). 如果公众平台传递过来的消息类型不在设定的类型列表中, 那么系统将不会把此消息路由至此模块')?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-md-3">
                                            <div style="margin-left:-15px;margin-top:7px">
                                                <a href="javascript:;" onclick="$(this).parent().parent().parent().remove()" class="icon ion-android-cancel" title="删除此菜单"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="add">
                                        <a href="javascript:;" class="m-l" onclick="addOption('cover',this);">添加菜单 <i class="icon ion-android-add-circle" title="添加菜单"></i></a>
                                    </div>
                                </div>
                                <div class="help-block">前台(含api/微信)导航入口菜单,点击后进入系统中对应的功能..</div>
                                ...
                                <div class="help-block">后台管理中心导航菜单将会在管理中心生成一个导航入口(管理后台操作), 用于对模块定义的内容进行管理.</div>
                                <div class="hr-line-dashed"></div>
...
<script id="menuModel" type="text/html">
    <div class="col-sm-12">
        ...
        <div class="col-md-3">
            <div style="margin-left:-15px;margin-top:7px">
                <a href="javascript:void(0);" onclick="$(this).parent().parent().parent().remove()" class="icon ion-android-cancel" title="删除此菜单"></a>
            </div>
        </div>
    </div>
</script>
