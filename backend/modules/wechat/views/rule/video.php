            ...
            <div class="form-group required">
                ...
                <div class="rule-photo-list">
                    <div class="img-box" data-toggle="modal" data-target="#baseModel" onclick="indexAttachment()">
                        ...
                        <div class="bottomBar"><?= isset($moduleModel->attachment->file_name) ? $moduleModel->attachment->file_name : '点击选择视频'?></div>
                    </div>
                    <input name="ReplyVideo[media_id]" value="<?= $moduleModel->media_id ?>" id="media_id" type="hidden">
                </div>
            </div>
