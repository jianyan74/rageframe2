    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close closeAjaxModalLgForExpress"><span aria-hidden="true">×</span><span class="sr-only">关闭</span></button>
                            ...
                            <td class="js-regions">
                                <?php foreach ($item as $province){ ?>
                                    <div class="shopProvinces">
                                        ...
                                        <!-- 显示市-->
                                        <?php if ($level >= 2){ ?>
                                            <i class="icon ion-arrow-down-b drop-down" data-level="province" data-open="0"></i>
                                            <div class="shopCitys">
                                                <?php foreach ($province['-'] as $city){ ?>
                                                    <div>
                                                        ...
                                                        <!-- 显示区-->
                                                        <?php if ($level >= 3){ ?>
                                                            <i class="icon ion-arrow-down-b drop-down" data-level="city" data-open="0"></i>
                                                            <div class="shopAreas">
