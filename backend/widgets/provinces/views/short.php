...
<div class="row">
    <?php if ($level >= 1){ ?>
        <div class="col-lg-<?= $col; ?>">
            <?= $form->field($model, $provincesName)->dropDownList(Yii::$app->services->provinces->getCityList(), [
                    'prompt' => '-- 请选择省 --',
    ...
    <?php if ($level >= 2){ ?>
        <div class="col-lg-<?= $col; ?>">
            <?= $form->field($model, $cityName)->dropDownList(Yii::$app->services->provinces->getCityList($model->$provincesName, 2), [
                    'prompt' => '-- 请选择市 --',
    ...
    <?php if ($level >= 3){ ?>
        <div class="col-lg-<?= $col; ?>">
            <?= $form->field($model, $areaName)->dropDownList(Yii::$app->services->provinces->getCityList($model->$cityName, 3), [
                'prompt' => '-- 请选择区 --',
            ]) ?>
        </div>
    <?php }?>
