...
namespace common\models\merapi;
...
class AccessToken extends RateLimit
{
    ...
    public static function findIdentityByAccessToken($token, $type = null)
    {
        ...
        $accessToken = Yii::$app->services->merapiAccessToken->getTokenToCache($token, $type);
        $accessToken && Yii::$app->services->merchant->setId($accessToken->merchant_id);
