...
class Account extends \yii\db\ActiveRecord
{
    ...
    const TYPE_SUBSCRIBE = "subscribe"; // 关注事件
    const TYPE_UN_SUBSCRIBE = "unsubscribe";// 取消关注事件
    const TYPE_EVENT_LOCATION = "LOCATION";// 上传地址事件
    const TYPE_EVENT_VIEW = "VIEW";// 访问链接事件
    const TYPE_CILCK = "CLICK";// 点击事件
    const TYPE_SCAN = "SCAN";// 二维码扫描事件
