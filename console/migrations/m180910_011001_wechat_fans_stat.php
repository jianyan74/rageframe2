...
class m180910_011001_wechat_fans_stat extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%wechat_fans_stat}}',['id'=>'143','new_attention'=>'0','cancel_attention'=>'0','cumulate_attention'=>'0','date'=>'2018-09-10','status'=>'1','created_at'=>'1536508800','updated_at'=>'1536541376']);
