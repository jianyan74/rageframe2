...
class m180921_014941_sys_auth_item extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_sys_auth_rule_5655_00','{{%sys_auth_item}}', 'rule_name', '{{%sys_auth_rule}}', 'name', 'CASCADE', 'CASCADE' );
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'/sys/cache/clear','type'=>'2','key'=>'7','description'=>'清除缓存','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'1','level'=>'2','sort'=>'2','created_at'=>'1536813537','updated_at'=>'1536813553']);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'/sys/manager/up-passwd','type'=>'2','key'=>'6','description'=>'修改密码','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'1','level'=>'2','sort'=>'0','created_at'=>'1536813520','updated_at'=>'1536813520']);
