...
class m180930_080440_member_info extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 索引设置 */
        $this->createIndex('access_token','{{%member_info}}','access_token',1);
        $this->createIndex('refresh_token','{{%member_info}}','refresh_token',1);
