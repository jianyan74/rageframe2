...
class m180930_080441_sys_auth_item_child extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_sys_auth_item_0965_00','{{%sys_auth_item_child}}', 'parent', '{{%sys_auth_item}}', 'name', 'CASCADE', 'CASCADE' );
        $this->addForeignKey('fk_sys_auth_item_0965_01','{{%sys_auth_item_child}}', 'child', '{{%sys_auth_item}}', 'name', 'CASCADE', 'CASCADE' );
