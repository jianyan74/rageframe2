...
class m181122_084407_sys_config_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%sys_config_cate}}',['id'=>'17','title'=>'网站配置','pid'=>'1','level'=>'2','sort'=>'0','status'=>'1','created_at'=>'1497177421','updated_at'=>'1526523354']);
        ...
        $this->insert('{{%sys_config_cate}}',['id'=>'28','title'=>'WebHook','pid'=>'0','level'=>'1','sort'=>'20','status'=>'1','created_at'=>'1532394994','updated_at'=>'1532394994']);
        $this->insert('{{%sys_config_cate}}',['id'=>'29','title'=>'Gitee','pid'=>'28','level'=>'2','sort'=>'0','status'=>'1','created_at'=>'1532395003','updated_at'=>'1532395003']);
