...
class m181122_084407_sys_sms_log extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 索引设置 */
        $this->createIndex('error_code','{{%sys_sms_log}}','error_code',0);
