...
class m181228_021615_wechat_attachment_news extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%wechat_attachment_news}}', [
            ...
            'thumb_url' => 'varchar(255) NULL DEFAULT \'\' COMMENT \'缩略图Url\'',
            'author' => 'varchar(64) NULL DEFAULT \'\' COMMENT \'作者\'',
            'digest' => 'varchar(255) NULL DEFAULT \'\' COMMENT \'简介\'',
            ...
            'media_url' => 'varchar(255) NULL DEFAULT \'\' COMMENT \'资源Url\'',
