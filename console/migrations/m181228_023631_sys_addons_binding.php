...
class m181228_023631_sys_addons_binding extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%sys_addons_binding}}',['id'=>'5','addons_name'=>'RfArticle','entry'=>'menu','title'=>'回收站','route'=>'article/recycle','icon'=>'fa fa-trash']);
        $this->insert('{{%sys_addons_binding}}',['id'=>'6','addons_name'=>'RfArticle','entry'=>'cover','title'=>'首页入口','route'=>'index/index','icon'=>'']);
