...
class m190218_025043_sys_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
...
1:开启;','remark'=>'开启此项后，连接将用SSL的形式，此项需要SMTP服务器支持','value'=>'0','is_hide_remark'=>'0','sort'=>'3','status'=>'1','created_at'=>'1526438237','updated_at'=>'1526439059']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'48','title'=>'用户凭证','name'=>'storage_qiniu_accesskey','type'=>'text','cate_id'=>'15','extra'=>'','remark'=>'ak','value'=>'','is_hide_remark'=>'0','sort'=>'0','status'=>'1','created_at'=>'1527032360','updated_at'=>'1546657094']);
        $this->insert('{{%sys_config}}',['id'=>'49','title'=>'签名密钥','name'=>'storage_qiniu_secrectkey','type'=>'text','cate_id'=>'15','extra'=>'','remark'=>'sk','value'=>'','is_hide_remark'=>'0','sort'=>'1','status'=>'1','created_at'=>'1527032390','updated_at'=>'1546657094']);
        $this->insert('{{%sys_config}}',['id'=>'50','title'=>'域名','name'=>'storage_qiniu_domain','type'=>'text','cate_id'=>'15','extra'=>'','remark'=>'domain','value'=>'','is_hide_remark'=>'0','sort'=>'2','status'=>'1','created_at'=>'1527032506','updated_at'=>'1546657382']);
        $this->insert('{{%sys_config}}',['id'=>'51','title'=>'空间名','name'=>'storage_qiniu_bucket','type'=>'text','cate_id'=>'15','extra'=>'','remark'=>'七牛的后台管理页面自己创建的空间名','value'=>'','is_hide_remark'=>'0','sort'=>'3','status'=>'1','created_at'=>'1527032578','updated_at'=>'1546657382']);
