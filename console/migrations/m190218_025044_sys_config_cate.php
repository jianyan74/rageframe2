...
class m190218_025044_sys_config_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%sys_config_cate}}', [
            ...
            'pid' => 'int(10) unsigned NULL COMMENT \'上级id\'',
        ...
        $this->insert('{{%sys_config_cate}}',['id'=>'25','title'=>'小程序','pid'=>'3','level'=>'2','sort'=>'1','status'=>'1','created_at'=>'1526711398','updated_at'=>'1546936292']);
        ...
        $this->insert('{{%sys_config_cate}}',['id'=>'32','title'=>'App推送','pid'=>'0','level'=>'1','sort'=>'9','status'=>'1','created_at'=>'1548405074','updated_at'=>'1548405080']);
        $this->insert('{{%sys_config_cate}}',['id'=>'33','title'=>'极光推送','pid'=>'32','level'=>'2','sort'=>'0','status'=>'1','created_at'=>'1548405087','updated_at'=>'1548405087']);
