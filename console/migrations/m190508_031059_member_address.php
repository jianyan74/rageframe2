...
class m190508_031059_member_address extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%member_address}}', [
            ...
            'province_id' => "int(10) unsigned NULL COMMENT '省id'",
            'city_id' => "int(10) unsigned NULL COMMENT '市id'",
            'area_id' => "int(10) unsigned NULL COMMENT '区id'",
