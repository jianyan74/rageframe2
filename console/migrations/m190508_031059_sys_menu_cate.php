...
class m190508_031059_sys_menu_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%sys_menu_cate}}',['id'=>'1','title'=>'平台首页','icon'=>'fa-bookmark','is_default_show'=>'1','is_addon'=>'0','sort'=>'0','level'=>'1','tree'=>'tr_0','pid'=>'0','status'=>'1','created_at'=>'1528042032','updated_at'=>'1553833466']);
        $this->insert('{{%sys_menu_cate}}',['id'=>'2','title'=>'微信公众号','icon'=>'fa-wechat','is_default_show'=>'0','is_addon'=>'0','sort'=>'1','level'=>'1','tree'=>'tr_0','pid'=>'0','status'=>'1','created_at'=>'1528042033','updated_at'=>'1553833452']);
