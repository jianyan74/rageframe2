...
class m190508_031100_wechat_qrcode_stat extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%wechat_qrcode_stat}}', [
            ...
            'qrcord_id' => "int(10) unsigned NULL COMMENT '二维码id'",
