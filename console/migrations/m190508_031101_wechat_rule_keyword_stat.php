...
class m190508_031101_wechat_rule_keyword_stat extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%wechat_rule_keyword_stat}}', [
            ...
            'keyword_id' => "int(10) unsigned NULL COMMENT '关键字id'",
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信_触发关键字记录表'");
