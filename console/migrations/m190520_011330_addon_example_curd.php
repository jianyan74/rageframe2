...
class m190520_011330_addon_example_curd extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%addon_example_curd}}', [
            ...
            'cate_id' => "int(10) unsigned NOT NULL COMMENT '分类ID(单选)'",
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='扩展_示例插件_curd'");
