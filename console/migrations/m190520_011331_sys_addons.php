...
class m190520_011331_sys_addons extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%sys_addons}}',['id'=>'112','title'=>'内容管理','name'=>'RfArticle','title_initial'=>'N','cover'=>'','group'=>'plug','brief_introduction'=>'内置基础的单页，文章管理','description'=>'文章管理','config'=>NULL,'author'=>'简言','version'=>'1.0.0','wechat_message'=>'a:0:{}','is_setting'=>'0','is_hook'=>'1','is_rule'=>'0','is_mini_program'=>'0','status'=>'1','created_at'=>'1550453696','updated_at'=>'1550453696']);
        $this->insert('{{%sys_addons}}',['id'=>'113','title'=>'购物节','name'=>'RfSignShoppingDay','title_initial'=>'G','cover'=>'','group'=>'activity','brief_introduction'=>'购物节签到抽奖','description'=>'购物节签到活动，每日可签到抽奖一次, 随机获取奖品','config'=>NULL,'author'=>'简言','version'=>'1.0.0','wechat_message'=>'a:0:{}','is_setting'=>'1','is_hook'=>'0','is_rule'=>'0','is_mini_program'=>'0','status'=>'1','created_at'=>'1550453702','updated_at'=>'1552984388']);
        $this->insert('{{%sys_addons}}',['id'=>'114','title'=>'示例管理','name'=>'RfExample','title_initial'=>'S','cover'=>'','group'=>'plug','brief_introduction'=>'系统的功能示例','description'=>'系统自带的功能使用示例及其说明，包含一些简单的交互','config'=>NULL,'author'=>'简言','version'=>'1.0.0','wechat_message'=>'a:4:{i:0;s:5:"image";i:1;s:5:"voice";i:2;s:5:"video";i:3;s:10:"shortvideo";}','is_setting'=>'1','is_hook'=>'1','is_rule'=>'1','is_mini_program'=>'1','status'=>'1','created_at'=>'1550640484','updated_at'=>'1550640484']);
