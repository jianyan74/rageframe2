...
class m190520_011331_sys_menu_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%sys_menu_cate}}',['id'=>'3','title'=>'系统管理','icon'=>'fa-cogs','is_default_show'=>'0','sort'=>'2','status'=>'1','created_at'=>'1528042096','updated_at'=>'1546936734']);
