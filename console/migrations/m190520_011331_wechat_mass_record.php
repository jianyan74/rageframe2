...
class m190520_011331_wechat_mass_record extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%wechat_mass_record}}', [
            ...
            'fans_num' => "int(10) unsigned NULL COMMENT '粉丝数量'",
            'msg_id' => "bigint(20) NULL COMMENT '微信消息id'",
