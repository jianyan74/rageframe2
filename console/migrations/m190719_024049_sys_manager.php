...
class m190719_024049_sys_manager extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%sys_manager}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统_后台管理员表'");
        
        /* 索引设置 */
        
        
        /* 表数据 */
        $this->insert('{{%sys_manager}}',['id'=>'1','merchant_id'=>'1','username'=>'admin','password_hash'=>'$2y$13$IToqjsbzBVmTzTvtEhxx/ebdhlnTZbeoQT9gjss6Ubba30d/BNM1m','auth_key'=>'z6lrwixmdNF4VqtkXw6z-3vMZdSdngm2','password_reset_token'=>'','type'=>'10','realname'=>'简言','head_portrait'=>'','gender'=>'1','qq'=>'','email'=>'','birthday'=>'2016-04-16','province_id'=>'330000','city_id'=>'330200','area_id'=>'330203','address'=>'大潮街道666号','mobile'=>'','home_phone'=>'','visit_count'=>'0','last_time'=>'1563500408','last_ip'=>'127.0.0.1','role'=>'10','status'=>'1','created_at'=>'1449114934','updated_at'=>'1563500408']);
