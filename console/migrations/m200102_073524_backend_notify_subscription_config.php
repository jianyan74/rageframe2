...
class m200102_073524_backend_notify_subscription_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        ], "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统_消息配置表'");
