...
class m200102_073524_common_action_behavior extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%common_action_behavior}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统_行为表'");
        ...
        $this->insert('{{%common_action_behavior}}',['id'=>'2','app_id'=>'backend','url'=>'base/manager/ajax-edit','method'=>'POST','behavior'=>'updateAccountPassword','action'=>'1','level'=>'info','is_record_post'=>'0','is_ajax'=>'0','remark'=>'创建/修改管理员账号密码','addons_name'=>'','is_addon'=>'0','status'=>'1','created_at'=>'1564221741','updated_at'=>'1565316796']);
        ...
        $this->insert('{{%common_action_behavior}}',['id'=>'4','app_id'=>'backend','url'=>'base/manager/destroy','method'=>'*','behavior'=>'deleteManager','action'=>'1','level'=>'warning','is_record_post'=>'1','is_ajax'=>'2','remark'=>'删除管理员','addons_name'=>'','is_addon'=>'0','status'=>'1','created_at'=>'1564223374','updated_at'=>'1566798482']);
        $this->insert('{{%common_action_behavior}}',['id'=>'5','app_id'=>'backend','url'=>'base/manager/up-password','method'=>'POST','behavior'=>'updatePassword','action'=>'1','level'=>'info','is_record_post'=>'0','is_ajax'=>'0','remark'=>'修改管理员密码','addons_name'=>'','is_addon'=>'0','status'=>'1','created_at'=>'1564223463','updated_at'=>'1565316780']);
