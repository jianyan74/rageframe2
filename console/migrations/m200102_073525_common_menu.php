...
class m200102_073525_common_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%common_menu}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统_菜单导航表'");
        ...
        $this->insert('{{%common_menu}}',['id'=>'4','title'=>'角色管理','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'2','pid'=>'2','url'=>'/common/auth-role/index','icon'=>'','level'=>'2','dev'=>'0','sort'=>'999','params'=>'[]','tree'=>'tr_0 tr_2 ','status'=>'1','created_at'=>'1572329079','updated_at'=>'1572329079']);
        $this->insert('{{%common_menu}}',['id'=>'5','title'=>'权限管理','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'2','pid'=>'2','url'=>'/common/auth-item/index','icon'=>'','level'=>'2','dev'=>'1','sort'=>'999','params'=>'[]','tree'=>'tr_0 tr_2 ','status'=>'1','created_at'=>'1572329162','updated_at'=>'1572560438']);
        ...
        $this->insert('{{%common_menu}}',['id'=>'20','title'=>'会员管理','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'0','url'=>'indexMember','icon'=>'fa-user','level'=>'1','dev'=>'0','sort'=>'999','params'=>'[]','tree'=>'tr_0 ','status'=>'1','created_at'=>'1572331063','updated_at'=>'1572331063']);
        ...
        $this->insert('{{%common_menu}}',['id'=>'168','title'=>'网站设置','app_id'=>'merchant','addons_name'=>'','is_addon'=>'0','cate_id'=>'4','pid'=>'0','url'=>'/common/config/edit-all','icon'=>'fa-cog','level'=>'1','dev'=>'0','sort'=>'0','params'=>'[]','tree'=>'tr_0 ','status'=>'1','created_at'=>'1572587305','updated_at'=>'1572587308']);
        $this->insert('{{%common_menu}}',['id'=>'169','title'=>'用户权限','app_id'=>'merchant','addons_name'=>'','is_addon'=>'0','cate_id'=>'4','pid'=>'0','url'=>'merchantMemberAuth','icon'=>'fa-user-secret','level'=>'1','dev'=>'0','sort'=>'999','params'=>'[]','tree'=>'tr_0 ','status'=>'1','created_at'=>'1572587403','updated_at'=>'1572849864']);
        $this->insert('{{%common_menu}}',['id'=>'170','title'=>'后台用户','app_id'=>'merchant','addons_name'=>'','is_addon'=>'0','cate_id'=>'4','pid'=>'169','url'=>'/base/member/index','icon'=>'','level'=>'2','dev'=>'0','sort'=>'999','params'=>'[]','tree'=>'tr_0 tr_169 ','status'=>'1','created_at'=>'1572587426','updated_at'=>'1572587426']);
        $this->insert('{{%common_menu}}',['id'=>'171','title'=>'角色管理','app_id'=>'merchant','addons_name'=>'','is_addon'=>'0','cate_id'=>'4','pid'=>'169','url'=>'/common/auth-role/index','icon'=>'','level'=>'2','dev'=>'0','sort'=>'999','params'=>'[]','tree'=>'tr_0 tr_169 ','status'=>'1','created_at'=>'1572587445','updated_at'=>'1572587445']);
        $this->insert('{{%common_menu}}',['id'=>'513','title'=>'会员日志','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'0','url'=>'memberCreditsLog','icon'=>'fa-file-text','level'=>'1','dev'=>'0','sort'=>'999','params'=>'[]','tree'=>'tr_0 ','status'=>'1','created_at'=>'1575548068','updated_at'=>'1575548080']);
