...
class m200102_073525_common_menu_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%common_menu_cate}}',['id'=>'4','title'=>'系统管理','app_id'=>'merchant','addons_name'=>'','icon'=>'fa-cogs','is_default_show'=>'0','is_addon'=>'0','addon_centre'=>'0','sort'=>'1000','level'=>'1','tree'=>'tr_0 ','pid'=>'0','status'=>'1','created_at'=>'1572508377','updated_at'=>'1572587324']);
        $this->insert('{{%common_menu_cate}}',['id'=>'5','title'=>'应用中心','app_id'=>'merchant','addons_name'=>'','icon'=>'fa-th-large','is_default_show'=>'0','is_addon'=>'0','addon_centre'=>'1','sort'=>'1001','level'=>'1','tree'=>'tr_0 ','pid'=>'0','status'=>'1','created_at'=>'1572508332','updated_at'=>'1572508332']);
        $this->insert('{{%common_menu_cate}}',['id'=>'6','title'=>'平台首页','app_id'=>'merchant','addons_name'=>'','icon'=>'fa-bookmark','is_default_show'=>'1','is_addon'=>'0','addon_centre'=>'0','sort'=>'0','level'=>'1','tree'=>'tr_0 ','pid'=>'0','status'=>'1','created_at'=>'1577672798','updated_at'=>'1577698651']);
