...
class m200311_020628_member_balance_withdraw extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%member_balance_withdraw}}', [
            ...
            'withdraw_status' => "smallint(6) NULL DEFAULT '0' COMMENT '当前状态 0已申请(等待处理) 1已同意 -1 已拒绝'",
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%member_balance_withdraw}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
