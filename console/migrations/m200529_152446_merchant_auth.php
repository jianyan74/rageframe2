...
class m200529_152446_merchant_auth extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%merchant_auth}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='商家_第三方绑定'");
        
        /* 索引设置 */
        $this->createIndex('oauth_client','{{%merchant_auth}}','oauth_client, oauth_client_user_id',0);
        $this->createIndex('member_id','{{%merchant_auth}}','member_id',0);
