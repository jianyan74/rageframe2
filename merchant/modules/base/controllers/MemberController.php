...
namespace merchant\modules\base\controllers;
...
use merchant\modules\base\forms\PasswdForm;
use merchant\modules\base\forms\MemberForm;
...
class MemberController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $authIds = Yii::$app->services->authRole->getChildIds(AppEnum::MERCHANT);
    ...
    public function actionAjaxEdit()
    {
        ...
        return $this->renderAjax($this->action->id, [
            'model' => $model,
            'roles' => Yii::$app->services->authRole->getLoginRoleChildUsers(AppEnum::MERCHANT),
        ]);
    }
