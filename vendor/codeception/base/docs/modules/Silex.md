...
{
   $this->assertContains($text, $this->getModule('Silex')->_getResponseContent(), "response contains");
}
?>
```
...
<p>&nbsp;</p><div class="alert alert-warning">Module reference is taken from the source code. <a href="https://github.com/Codeception/Codeception/tree/2.5/src/Codeception/Module/Silex.php">Help us to improve documentation. Edit module reference</a></div>
