Contributing to yii2-krajee-base
================================
Looking to contribute something to yii2-krajee-base? **Here's how you can help.**
...
The issue tracker **is not** a place for support requests. Refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get programming help.

Reporting bugs with yii2-krajee-base
------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-krajee-base_.
...
- What version of jQuery are you using? And what version of yii2-krajee-base?
- Are you using yii2-krajee-base with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-krajee-base
------------------------------------------
Before starting work on a major feature for yii2-krajee-base, **read the
[README](https://github.com/kartik-v/yii2-krajee-base/blob/master/README.md)  first** or you may risk spending a considerable amount of
...
yii2-krajee-base regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-krajee-base that contain test cases and
...
It should also be made clear that **all code contributed to yii2-krajee-base** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[issue-search]: https://github.com/kartik-v/yii2-krajee-base/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/yii2-krajee-base/issues
[licensing]: https://github.com/kartik-v/yii2-krajee-base/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-krajee-base
[requesting-features]: #requesting-features-in-yii2-krajee-base